...
public class CategoryLogicLayer3 implements CategoryLogic {

	private static final Logger log = LogManager.getLogger(CategoryLogicLayer3.class);
	...
	public Category createCategory() {
		...
		Category category = Category.builder()
				...
				.categoryCodeLayer2(dto.getCategoryCodeLayer2())
				.categoryCodeLayer3(dto.getCategoryCodeLayer3())
